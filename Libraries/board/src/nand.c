...
void Nand_Init(void)
{
  ...
  FMC_SpaceTimingStruct.FMC_SetupTime = 0x01;
  FMC_SpaceTimingStruct.FMC_WaitSetupTime = 0x03;
  FMC_SpaceTimingStruct.FMC_HiZSetupTime = 0x02;
  FMC_SpaceTimingStruct.FMC_HoldSetupTime = 0x01;
